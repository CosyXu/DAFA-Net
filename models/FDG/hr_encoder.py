"""
Configurations for HRNet.

Parts of the code adapted from https://github.com/HRNet/HRNet-Semantic-Segmentation.
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.num_ch_enc = [64, 18, 36, 72, 144]    # DIY
...
def _hrnet(arch, pretrained, progress, **kwargs):
    from models.FDG.hr_config import MODEL_CONFIGS
