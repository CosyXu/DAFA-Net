"""
Generate look up tables during depth estimation training for DAFA-Net.

The code is adapted from https://github.com/valeoai/WoodScape.
...
if __name__ == "__main__":
    ...
    # Cropping to remove the black regions of the car (impacts the depth estimation task)
